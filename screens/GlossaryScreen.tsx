...
const SECTIONS: GlossarySection[] = [
  ...
  {
    title: "Post Info Page",
    entries: [
      { icon: "Info", title: "Post Info", description: "A detailed view of any post showing its on-chain data, engagement stats, ownership fractions, and creator info. Access it by tapping the info icon on any post." },
      { icon: "Hash", title: "Token ID", description: "The unique on-chain identifier assigned when a post is minted as an NFT. Shown at the top of the Post Info page." },
      { icon: "ExternalLink", title: "Transaction Hash", description: "The blockchain transaction hash from when the post was minted. Open it in the block explorer (BaseScan or BscScan) to verify the on-chain record." },
      { icon: "Eye", title: "Engagement Stats", description: "The Post Info page shows total likes, dislikes, views, comments, and tips received — a complete snapshot of how the post is performing." },
      { icon: "Globe", title: "Visibility Control", description: "Post owners can change visibility between Public (anyone can see), Unlisted (only via direct link), and Private (only you). Accessible from the Post Info page." },
      { icon: "EyeOff", title: "Unlisted", description: "A visibility setting where the post won't appear in feeds or search, but anyone with the direct link can still view it." },
      { icon: "Pencil", title: "Edit Post (from Info)", description: "Post owners can edit the title and description of their post directly from the Post Info page by tapping the edit button." },
      { icon: "HandCoins", title: "Total Tips Received", description: "Shows the total amount of DHB tips the post has earned from viewers, displayed on the Post Info page." },
      { icon: "Ticket", title: "PPV Purchases", description: "For pay-per-view posts, shows how many users have purchased access and the total revenue earned by the creator." },
    ],
  },
  {
    title: "Fractions & Ownership",
    entries: [
      { icon: "ChartPie", title: "Fractions", description: "Every post on DeHub is minted as an NFT split into 100 fractions. The creator starts with all 100 fractions, representing 100% ownership of the content." },
      { icon: "Users", title: "Holders", description: "The list of wallet addresses that own fractions of a post. Shown on the Post Info page with each holder's balance and ownership percentage." },
      { icon: "ChartColumn", title: "Ownership Bar", description: "A progress bar on the Post Info page showing how many of the 100 fractions the creator still holds vs. how many have been distributed or sold." },
      { icon: "Tag", title: "List Fractions", description: "If you own fractions of a post, you can list them for sale at a price you set (in DHB per fraction). Other users can then purchase your listed fractions." },
      { icon: "Coins", title: "Fraction Marketplace", description: "The marketplace tab on the Post Info page where fraction holders can list fractions for sale and buyers can make offers. Enables trading of content ownership." },
      { icon: "Plus", title: "Make Offer", description: "Submit a buy offer for fractions of a post at a price you choose. The fraction holder can accept or reject your offer." },
    ],
  },
  {
    title: "Wallet & Tokens",
