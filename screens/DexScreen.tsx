...
export default function DexScreen() {
  ...
  return <View style={s.root}><ScreenHeader title={t('dex.title')} onBackPress={() => navigation.goBack()} /><ScrollView contentContainerStyle={s.content} keyboardShouldPersistTaps="handled">
    ...
    <View style={s.notice} accessibilityRole="text"><Text style={s.noticeText}>{t('dex.launchNotice')}</Text></View>
...
const s = StyleSheet.create({
  ...
  notice: { backgroundColor: '#111d26', borderColor: '#2f4a5c', borderWidth: 1, padding: 12, marginTop: 12, borderRadius: 6 }, noticeText: { color: '#c9dbe8', fontSize: 12, lineHeight: 18 },
