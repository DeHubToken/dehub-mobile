/**
 * MessageBubble — Instagram / WhatsApp–style chat bubble.
 *
 * Features:
 * - CDN-only media (no local storage layer)
 * - Text, image, video, GIF, and voice note rendering
 * - "edited" / "forwarded" tags
 * - Read receipts (double-check marks)
 * - Timestamp on long-press (or always-on for media)
 * - Animate-in with scale + fade for new messages
 * - Long-press opens MessageContextMenu via measured layout
 */
...
const MessageBubbleComponent: React.FC<MessageBubbleProps> = ({
  ...
  // ── Tip message — render as centred system info, not a bubble ──────────
