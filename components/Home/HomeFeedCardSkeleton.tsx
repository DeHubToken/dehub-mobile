 ...
 * Matches the actual HomeFeedCard layout exactly
 */
...
const HomeFeedCardSkeleton: React.FC = () => {
  return (
    <View className="my-4">
      {/* Header skeleton - matches FeedCardHeader */}
      ...
      {/* Action bar skeleton - matches exact layout */}
