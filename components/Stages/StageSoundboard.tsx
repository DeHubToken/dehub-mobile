...
const BUILT_IN_SOUNDS: BuiltInSound[] = [
  ...
  { id: "lol", label: "stages.sfx.lol", emoji: "😂", file: "lol.mp3" },
  { id: "cricket", label: "stages.sfx.crickets", emoji: "🦗", file: "crickets.mp3" },
  ...
  { id: "ooh-ahh", label: "stages.sfx.oohAhh", emoji: "✨", file: "ooh-ahh.mp3" },
