...
const productionTokens = [
  ...
  // BSC
  {
    ...
    iconUrl: "/icons/tokens/DHB.png", // Update to relevant image URL if needed
...
export const supportedTokensForLockContent = supportedTokens.filter(
  (e) => e.symbol === "DHB"
);
...
export const expireSignTime =
  env.APP_ENV === "development" ? 60 * 60 * 2 : 60 * 60 * 24; // 2 hours
