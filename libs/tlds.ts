/**
 * Complete list of valid IANA Top-Level Domains (TLDs).
 * Only links ending with one of these TLDs should be rendered as clickable.
 * Source: https://data.iana.org/TLD/tlds-alpha-by-domain.txt
 */

export const TLD_SET: Set<string> = new Set([
  // Generic TLDs
  "aaa", "aab", "aarp", "abarth", "abb", "abbott", "abbvie", "abc", "able",
  "abogado", "abudhabi", "ac", "academy", "accenture", "accountant",
  "accountants", "aco", "active", "actor", "ad", "adac", "ads", "adult",
  "ae", "aeg", "aero", "aetna", "af", "afamilysale", "africa", "ag",
  "agakhan", "agency", "ai", "aig", "aigo", "airbus", "airforce", "airtel",
  "akdn", "al", "alfaromeo", "alibaba", "alipay", "allfinanz", "allstate",
  "ally", "alsace", "alstom", "am", "amazon", "americanexpress",
  "americanfamily", "amex", "amfam", "ami", "amsterdam", "an", "analytics",
  "android", "anquan", "anz", "ao", "aol", "apartments", "app", "apple",
  "aq", "aquarelle", "ar", "arab", "aramco", "archi", "army", "art",
  ...
  "bm", "bms", "bmw", "bn", "bnl", "bnpparibas", "bo", "boats",
  ...
  "cbre", "cbs", "cc", "cd", "ceb", "center", "ceo", "cern", "cf", "cfa",
  "cfd", "cg", "ch", "chanel", "channel", "charity", "chase", "chat",
  "cheap", "chintai", "christmas", "chronicle", "chrysler", "church", "ci",
  ...
  "county", "coupon", "coupons", "courses", "cpa", "cr", "credit",
  ...
  "download", "drive", "dtv", "dubai", "duck", "dunlop", "dupont",
  "durban", "dvag", "dvr", "dz",
  // E
  "earth", "eat", "ec", "eco", "edeka", "edu", "education", "ee", "eg",
  "email", "emerald", "energy", "engineer", "engineering", "enterprises",
  "epson", "equipment", "er", "ericsson", "erni", "es", "esq", "estate",
  "esurance", "et", "etisalat", "eu", "eurovision", "eus", "events",
  "everbank", "exchange", "expert", "exposed", "express", "extraspace",
  // F
  "fage", "fail", "fairwinds", "faith", "family", "fan", "fans", "farm",
  "farmers", "fashion", "fast", "fedex", "feedback", "ferrari", "ferrero",
  "fi", "fiat", "fidelity", "film", "final", "finance", "financial",
  ...
  "forsale", "forum", "foundation", "fox", "fr", "free", "fresenius",
  "frl", "frogans", "frontdoor", "frontier", "ftr", "fujitsu",
  "fujixerox", "fun", "fund", "furniture", "futbol", "fyi",
  // G
  ...
  "hsbc", "ht", "hu", "hughes", "hyatt", "hyundai",
  // I
  ...
  "int", "intel", "intuit", "investments", "io", "ipiranga", "iq", "ir",
  ...
  "ph", "pharmacy", "philips", "phone", "photo", "photography", "photos",
  "physio", "piaget", "pics", "pictet", "pictures", "pid", "pin", "ping",
  "pink", "pioneer", "pizza", "pk", "pl", "place", "play", "playstation",
  "plumbing", "plus", "pm", "pn", "pnc", "pobank", "pocket", "podcasts",
  "poet", "poker", "politie", "porn", "post", "pr", "pramerica", "praxi",
  ...
  // S
  "sa", "sabbatical", "safe", "safety", "sakura", "sale", "salon",
  ...
  "science", "scjohnson", "scor", "scot", "sd", "se", "search", "seat",
  ...
  "shouji", "show", "showtime", "shriram", "si", "silk", "sina", "singles",
  "site", "sj", "sk", "ski", "skin", "sky", "skype", "sl", "sling", "sm",
  "smart", "smile", "sn", "sncf", "so", "soccer", "social",
  "softbank", "software", "sohu", "solar", "solutions", "song", "sony",
  "soy", "spa", "space", "sport", "spot", "spreadbetting", "sr", "srl",
  "srt", "ss", "st", "stada", "staples", "star", "statebank",
  ...
  "xn--fiq228c5hs", "xn--fiq64b", "xn--fiq8iy", "xn--fiqs8s",
  ...
  "xn--kpry57d", "xn--kpu716f", "xn--l1acc", "xn--lgbbat1ad8j",
  ...
  "xn--o3cw4h", "xn--ogbpf8fl", "xn--otu796d", "xn--p1acf", "xn--p1ai",
  "xn--pbt977c", "xn--pgbs0dh", "xn--pssy2u", "xn--q7ce6a",
  ...
  "xn--unup4y", "xn--vermgensberater-ctb",
...
/**
 * Check whether a domain's TLD is valid.
 * Extracts the TLD from the hostname portion of a URL or bare domain.
 * Returns true if the TLD is in the IANA list.
 */
export function hasValidTLD(urlOrDomain: string): boolean {
  try {
    // Strip protocol and path to get hostname
    let host = urlOrDomain.replace(/^(?:https?:\/\/)?(?:www\.)?/i, "");
