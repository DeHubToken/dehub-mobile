...
export type AffiliateLandingCustomization = {
  ...
  ctaLabel: string;
  destination: string;
  /** Extra destinations shown next to the primary button on the web invite page (0 to 5). */
...
/** Ready-made DeHub destinations an affiliate can add in one tap (mirrors web). */
