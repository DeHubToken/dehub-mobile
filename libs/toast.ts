...
const base = (message: string, opts?: Parameters<typeof toast>[1]) => {
  return toast(message, {
    style: [{ backgroundColor: toastTheme.info.backgroundColor }, toastTheme.containerStyle],
    textStyle: [{ color: toastTheme.info.color }],
    ...opts,
  });
};
...
export const toastSuccess = (message: string, opts?: Parameters<typeof toast.success>[1]) =>
  toast.success(message, {
    style: [{ backgroundColor: toastTheme.success.backgroundColor }, toastTheme.containerStyle],
    textStyle: [{ color: toastTheme.success.color }],
    ...opts,
  });
...
export const toastError = (error: unknown, fallback = 'Something went wrong', opts?: Parameters<typeof toast.error>[1]) => {
  ...
  return toast.error(message, {
    style: [{ backgroundColor: toastTheme.error.backgroundColor }, toastTheme.containerStyle],
    textStyle: [{ color: toastTheme.error.color }],
    ...opts,
  });
};
...
export const toastWarning = (message: string, opts?: Parameters<typeof toast.warning>[1]) =>
  toast.warning(message, {
    style: [{ backgroundColor: toastTheme.warning.backgroundColor }, toastTheme.containerStyle],
    textStyle: [{ color: toastTheme.warning.color }],
    ...opts,
  });
