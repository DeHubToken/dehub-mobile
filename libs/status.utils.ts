...
export const statusOptions: { id: string; label: string; icon: IonIconName; color?: string }[] = [
  { id: 'trends', label: 'Most viewed', icon: 'trending-up-outline', color: '#D4D4D8' },
  { id: 'live', label: 'Live', icon: 'radio-outline', color: '#F4F4F5' },
  { id: 'new', label: 'New', icon: 'flash-outline', color: '#D4D4D8' },
  { id: 'mostLiked', label: 'Most Liked', icon: 'heart-outline', color: '#F4F4F5' },
  { id: 'ppv', label: 'Pay Per View', icon: 'cash-outline', color: '#F4F4F5' },
